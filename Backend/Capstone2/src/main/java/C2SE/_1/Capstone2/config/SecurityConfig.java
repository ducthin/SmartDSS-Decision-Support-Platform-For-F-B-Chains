        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/v1/public/config/tax")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET, "/api/v1/public/config/payments/**")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET, "/api/v1/public/home/**").permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/v1/public/home/bookings")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/v1/public/home/orders")
                                                .permitAll()
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/v1/public/payments/webhook")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST,
                                                                "/api/v1/public/payments/payos/webhook")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/v1/public/payments/orders/*/qr")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/v1/public/payments/orders/*/status")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET, "/api/v1/public/orders/track")
                                                .permitAll()
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/v1/settings/store-location")
                                                .permitAll()
                                                ...
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/menu/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.DELETE, "/api/v1/menu/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/v1/recipes/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/recipes/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.DELETE, "/api/v1/recipes/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                ...
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/tables/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/v1/settings/**").hasAnyRole(
                                                                ...
                                                                RoleName.MANAGER.name(),
                                                                RoleName.STAFF.name())
                                                .requestMatchers(HttpMethod.POST, "/api/v1/settings/**")
                                                .hasRole(RoleName.ADMIN.name())
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/settings/**")
                                                .hasRole(RoleName.ADMIN.name())
                                                .requestMatchers(HttpMethod.DELETE, "/api/v1/settings/**")
                                                .hasRole(RoleName.ADMIN.name())
                                                ...
                                                .requestMatchers("/api/v1/invoice-requests/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/v1/feedbacks/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/feedbacks/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())

                                                // Weather - GET: authenticated, POST: ADMIN/MANAGER
                                                .requestMatchers(HttpMethod.GET, "/api/v1/weather/**").authenticated()
                                                .requestMatchers(HttpMethod.POST, "/api/v1/weather/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/v1/holidays/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/holidays/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.DELETE, "/api/v1/holidays/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())

                                                // Vouchers - GET: authenticated, CUD: ADMIN/MANAGER
                                                .requestMatchers(HttpMethod.GET, "/api/v1/vouchers/**").authenticated()
                                                .requestMatchers(HttpMethod.POST, "/api/v1/vouchers/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/vouchers/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.DELETE, "/api/v1/vouchers/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())

                                                // Notifications - ADMIN, MANAGER
                                                .requestMatchers(HttpMethod.POST, "/api/v1/notifications/test")
                                                .hasAnyRole(
                                                                RoleName.ADMIN.name(),
                                                                RoleName.MANAGER.name())
                                                ...
                                                // Shift management
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shifts/my-assignments")
                                                .hasAnyRole(
                                                                RoleName.ADMIN.name(),
                                                                RoleName.MANAGER.name(),
                                                                RoleName.STAFF.name())
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shifts/my-attendance")
                                                .hasAnyRole(
                                                                RoleName.ADMIN.name(),
                                                                RoleName.MANAGER.name(),
                                                                RoleName.STAFF.name())
                                                .requestMatchers(HttpMethod.POST, "/api/v1/shifts/attendance/check-in")
                                                .hasAnyRole(
                                                                RoleName.ADMIN.name(),
                                                                RoleName.MANAGER.name(),
                                                                RoleName.STAFF.name())
                                                .requestMatchers(HttpMethod.POST, "/api/v1/shifts/attendance/check-out")
                                                .hasAnyRole(
                                                                RoleName.ADMIN.name(),
                                                                RoleName.MANAGER.name(),
                                                                RoleName.STAFF.name())
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shifts/attendance")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shifts/work-summary")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shifts/revenue-details")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shifts/work-summary.csv")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers("/api/v1/shifts/templates/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
                                                .requestMatchers("/api/v1/shifts/assignments/**")
                                                .hasAnyRole(RoleName.ADMIN.name(), RoleName.MANAGER.name())
