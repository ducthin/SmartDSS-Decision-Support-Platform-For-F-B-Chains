...
export default function TestimonialCard({ testimonial }: TestimonialCardProps) {
  return (
    <Card variant="testimonial" className="flex h-full flex-col gap-4 p-6">
      ...
      <p className="text-sm leading-relaxed text-[rgba(26,14,7,0.88)]">&ldquo;{testimonial.quote}&rdquo;</p>
      <div className="mt-auto flex items-center gap-3 pt-2">
        ...
        <div>
          ...
          <p className="text-xs text-[rgba(26,14,7,0.7)]">{testimonial.role}</p>
        </div>
      </div>
    </Card>
  );
