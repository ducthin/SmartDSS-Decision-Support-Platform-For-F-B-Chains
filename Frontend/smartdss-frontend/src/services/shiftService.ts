...
export const shiftService = {
  getTemplates: (activeOnly = true) =>
    api.get<ApiResponse<ShiftTemplate[]>>('/shifts/templates', { params: { activeOnly } }),
  ...
  getAssignments: (params?: { fromDate?: string; toDate?: string; userId?: number }) =>
  ...
  getAttendances: (params?: { fromDate?: string; toDate?: string; userId?: number }) =>
  ...
  getWorkSummary: (params?: { fromDate?: string; toDate?: string; userId?: number }) =>
    api.get<ApiResponse<ShiftWorkSummary[]>>('/shifts/work-summary', { params }),

  exportWorkSummaryCsv: (params?: { fromDate?: string; toDate?: string; userId?: number }) =>
