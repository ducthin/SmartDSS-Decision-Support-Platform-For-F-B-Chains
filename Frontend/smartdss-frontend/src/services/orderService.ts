...
export const orderService = {
  getAll: (page = 0, size = 10, status?: string, keyword?: string) =>
    api.get<ApiResponse<PageResponse<Order>>>('/orders', { params: { page, size, status: status || undefined, keyword: keyword || undefined } }),
